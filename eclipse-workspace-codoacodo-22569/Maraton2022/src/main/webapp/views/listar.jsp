		...
		<main class="container">
			<section>
				<table class="table bg-dark text-white">
				    ...
				    <tr>
 				     <td> <a class="link-success" href="corredores?opcion=editar&id=<c:out value="${corredor.id}"> </c:out>"> <c:out value="${corredor.id}"> </c:out> </a> </td>
				      ...
				      <td> <a class="link-success" href="corredores?opcion=eliminar&id=<c:out value="${corredor.id}"> </c:out>"> Eliminar </a></td>
